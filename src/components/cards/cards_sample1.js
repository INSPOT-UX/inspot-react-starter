...
export class CardsSample1 extends React.Component {
    render(){
        ...
        <div className="container  system-wrap">
            ...
            <div className='row card-container' style={{background: 'linear-gradient(to top, #141e30, #243b55)', padding: '4rem 4rem'}}>
                <CryptoCard
            ...
            <hr />
            <h2>Payment cards</h2>
            <div className="row card-container" style={{padding: '3rem 1rem 6rem'}}>
                <PaymentCard
