...
export class CarouselBasic01 extends React.Component {
    constructor(props) {
      super(props);
      this.state = { 
        items: [
    ...
    render(){
      let index = this.state.current,
          ...
          backgroundImageSrc = this.state.items[index],
          slideTitle = this.state.captionTitle[index];
          ...
          <div className="carousel">
           <CSSTransitionGroup
            ...
            transitionLeaveTimeout={500}>
               <div className="carousel_slide" key={index} style={{backgroundImage:`url(${backgroundImageSrc})`}}>
  ...
  export default CarouselBasic01;